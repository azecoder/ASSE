...
MOCK_AUTHSERVICE = 'http://127.0.0.1:5050'
...
def test_create_user(db, client, requests_mock):
    requests_mock.post( MOCK_AUTHSERVICE + '/users', status_code = 200)
...
def test_delete_user_by_id(db, client,requests_mock):
    requests_mock.delete(MOCK_AUTHSERVICE + '/users', status_code=200)
